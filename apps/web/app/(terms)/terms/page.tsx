...
const TermsAndConditions = () => {
  return (
    <div className="flex justify-center flex-col items-center text-lg text-slate-300 bg-gradient-to-b from-gray-900 via-slate-800 to-gray-900">
      <div className="w-full bg-slate-900 dark:bg-grid-white/[0.2] bg-grid-black/[0.2] rounded-lg shadow-xl">
        <div className="relative flex items-center justify-center">
          ...
          <div className="mt-8 mb-8 relative z-10 flex flex-col items-center gap-6">
            <Image src={logo} height={120} width={120} alt="Logo" className="drop-shadow-md" />
            <h1 className="text-4xl font-bold text-orange-400 mb-8 tracking-wider">Terms and Conditions</h1>

            <div className="text-left text-slate-300 space-y-6 max-w-3xl">
              <p>Welcome to Create My API! These terms and conditions outline the rules and regulations for the use of our website.</p>

              <h2 className="text-2xl font-semibold text-orange-500">Acceptance of Terms</h2>
              ...
              <h2 className="text-2xl font-semibold text-orange-500">License</h2>
              ...
              <h2 className="text-2xl font-semibold text-orange-500">Changes to the Terms</h2>
            ...
            <Link
              href="/"
              className="bg-gradient-to-r from-orange-500 to-yellow-500 px-6 py-3 rounded-full text-lg text-white font-semibold hover:scale-110 duration-200 hover:shadow-lg mt-8"
            >
              Go Home 🚀
            </Link>
          </div>
