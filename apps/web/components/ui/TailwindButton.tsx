...
const LinkedInButton = () => {
  return (
    <button className="group w-8 hover:w-40 h-8 hover:bg-sky-600 relative bg-sky-700 rounded text-neutral-50 duration-700 before:duration-700 before:hover:500 font-bold flex justify-start gap-2 items-center p-2 pr-6 before:absolute before:-z-10  before:w-6 before:h-6 before:bg-sky-700 before:hover:bg-sky-600 before:rotate-45">
      <svg
        y="0"
        ...
        height="20"
        className="w-4 h-4 shrink-0 fill-neutral-50"
      >
